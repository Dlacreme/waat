/*
** test_mic2.c in /home/dlacreme/Projects/waat/test
**
** Made by Mathieu Delacroix
** mathieu.delacroix.fr@gmail.com
**
** Started on  T3 Th06 20 19:37:33 2017 Creme
** Last update T3 Th06 20 19:40:40 2017 Creme
*/
...
"-logfn", "/dev/null",                                      // suppress log info from being sent to screen
 NULL);
  ...
  ad = ad_open_dev("adcdev", (int) cmd_ln_float32_r(config, "-samprate")); // open default microphone at default samplerate
